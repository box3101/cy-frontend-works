  ...
  return (
    <div className='history-section'>
      ...
      <div className='container'>
        <div className='col-12 text-center mb20'>
        ...
        <table>
          ...
          <tbody>
            {projects.map((project, index) => (
              <tr key={index} data-aos='fade-up' data-aos-delay={index * 100} data-aos-offset='-1000'>
                <td>{project.업무명}</td>
                <td>{project.참여기간}</td>
                <td>{project.고객사}</td>
                <td>{project.근무회사}</td>
